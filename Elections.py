...
######## Stack election results from many races into single dataframe ########
######## Most races have 2 files with the extensions below - merge horizontally then vertically stack ########
...
######## Assumes voting behaviors are uniform across a cntyvtd and between spanish_surname and general population ########
